...
const WeatherCard = ({ weather, color, onCardClick }) => {
  const [showDetailView, setShowDetailView] = useState(false); // State to toggle detailed view
  ...
  const handleCardClick = () => {
    setShowDetailView(true); // Show detailed view when card is clicked
  };

  const handleBackClick = () => {
    setShowDetailView(false); // Hide detailed view when back button is clicked
  };

  // Detailed view style, applying the same styles as the main card
  ...
  return (
    <>
      {showDetailView ? (
        <div className="detailed-weather-view" style={detailedViewStyle}>
          <div style={cardStyle}>
            <button
              style={closeButtonStyle}
              onClick={(e) => {
                e.stopPropagation(); // Prevent the click from triggering the card's onClick
                setShowDetailView(false); // Hide detailed view
              }}
            >
              X
            </button>
        ...
        <div
          ...
          style={cardStyle}
          onClick={handleCardClick} // Trigger click event when the card is clicked
        >
          <button
            style={closeButtonStyle}
            onClick={(e) => {
